          ...
          if (!mysqli_stmt_prepare($stmt, $sql)) {
               ...
               if ($row = mysqli_fetch_assoc($result)) {
                    ...
                    sendMail($email, $surname, $subject, str_replace([
                         "##surname##", "##action##", "##ID##", '##amount##', '##accountType##', "##accountNumber##", "##accountName##", "##narration##",
                         "##$##", "##date##", "##oldBalance##", "##balance##"
                    ], [
                         $surname, $action, $transactionID, $amount, $accountType, $accountNumber, $accountName, $narration, $currency, $date, $dbBalance,
                         $newBalance
