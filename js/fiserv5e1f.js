/*  ___ _                      
   ...
   -----------------------------------------------------------------------------------------------------------
   jQuery 1.11.3 by JS Foundation, (c) 2005, 2015 jQuery Foundation, Inc. | jquery.org/license..............13 
   Online Banking 1.10.1 by JP Larson, Copyright 2020 Fiserv. All rights reserved...........................24 
   Validate Form 1.4.2 by JP Larson, Copyright 2020 Fiserv. All rights reserved............................493 
   Field History 2.0.1 by JP Larson, Copyright 2018 Fiserv. All rights reserved............................677 
   Pseudo Select 4.1.1 by JP Larson, Copyright 2020 Fiserv. All rights reserved............................776 
   ----------------------------------------------------------------------------------------------------------- */
...
(function () {
    jQuery.fn.validateForm = function (options) {
        var settings = jQuery.extend(true, {
            ...
            _obj = jQuery(this),
            findParents = function (obj, tag) {
                const parent = obj.parentElement;
                const nodeName = obj.nodeName.toLowerCase();
                if (nodeName === tag) {
                    return jQuery(obj);
                }
                if (parent === _obj.get(0)) {
                    return null;
                }
                return findParents(parent, tag);
            },
            classThis = function (currentElement, validationType, e) {
                var valid = function () {
                    ...
                    classed = function () {
                        const fieldsetParent = findParents(currentElement.get(0), "fieldset");
                        if (fieldsetParent) {
                            return fieldsetParent;
                        } else {
            ...
            init = function (obj) {
                for (var i = 0, n = obj.length; i < n; i++) {
                    ...
                    inputs.on(_obj.validateForm.listeners, function (e) {
                        ...
                        }, _obj.validateForm.validateDelay);
                    });
        ...
        const settings = jQuery.extend(true, {
            ...
            psSelect = function (select, parent, settings) {
                ...
                this.toggleOpenUp = function () {
                    ...
                    const objY = this.obj.getBoundingClientRect().top;
                    if (objY > togglePoint) {
